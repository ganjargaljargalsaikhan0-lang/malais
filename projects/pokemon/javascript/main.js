...
function getTypeIcon(type) {
    const icons = {
        ...
        ice: "ice.png",
        fighting: "Vector (13).png",
        ground: "ground.png",
        flying: "flying.png",
        psychic: "Vector (1).png",
        bug: "bug.png",
        rock: "rock.png",
        ghost: "ghost.png",
        dragon: "dragon.png",
...
function displayPokemon(pokemonlist) {
    ...
    <span class="pokemon-type" 
          style="background: ${getTypeColor(type)}; border-radius: 999px; margin-left: 10px; display:flex; align-items:center; gap:5px;">
        
        <img src="${getTypeIcon(type)}" style="width:14px; height:14px;">
        ${type}
    </span>
`).join("");
...
searchInput.addEventListener("input", (e) => {
    ...
    const filtered = allPokemon.filter(pokemon => {
        return (
            ...
            pokemon.types.some(type => type.includes(value)) ||
            pokemon.id === numberValue
        );
    });
